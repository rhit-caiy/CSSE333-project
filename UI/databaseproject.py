...
window=Tk()
canvas=Canvas(window,bg="#DDDDDD",width=1400,height=660)#canvas size
...
#2... : pages to display informations and modify
#
...
def display(databasetablename,attribute,column):
    ...
    with pymssql.connect(server,user,password,database) as conn:
        ...
        #TODO: add stored procedure and display content from its return
